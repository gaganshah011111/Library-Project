...
<body oncontextmenu="return false" class="prevent-select">
    ...
    <?php
    include 'header.php';
    $dis = isset($_GET['library']) ? $_GET['library'] : 'home';
    ?>
    <!-- Header End -->
    ...
    <div style="<?php if ($dis != 'home') {
            ...
            <div class="container">
                ...
                <div class="container text-bg-light shadow px-3 py-5 mb-5 bg-body rounded mt-5">
                    ...
                    <div class="text-bg-light shadow px-3 pb-3 bg-body rounded">
                        ...
                        A "No Dues Certificate" is given to the borrower when he/she wishes to terminate the membership
                        of the
                        Library. The certificate can be obtained from the Library after surrending the membership ticket
                        and
                        clearing the dues.
                        </p>
                    </div>
        ...
        <!-- Book Details Start -->
        <div style="<?php if ($dis != 'books') {
                        echo " display: none";
                    } ?>">
            <div class="container">
                <h1 class="pt-3 text-primary text-center">Book Details & Collection</h1>
                <div class="container text-bg-light shadow px-3 py-5 mb-5 bg-body rounded mt-5">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded">
                                <h4 class="pt-3 text-primary">Engineering Books</h4>
                                <p>Comprehensive collection of engineering textbooks covering all major disciplines including Civil, Mechanical, Electrical, Computer Science, and Electronics & Communication Engineering.</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded">
                                <h4 class="pt-3 text-primary">Reference Books</h4>
                                <p>Extensive reference materials, handbooks, and technical guides for advanced study and research purposes.</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded">
                                <h4 class="pt-3 text-primary">Digital Resources</h4>
                                <p>Access to e-books, online journals, and digital databases for modern learning needs.</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded">
                                <h4 class="pt-3 text-primary">Periodicals & Journals</h4>
                                <p>Latest technical journals, magazines, and periodicals to keep you updated with current developments.</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <a href="?page=admin" class="btn btn-primary">Search Book Catalog</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="<?php if ($dis != 'papers') {
                        echo " display: none";
                    } ?>">
            <div class="container">
                <h1 class="pt-3 text-primary text-center">Question Papers Archive</h1>
                <div class="container text-bg-light shadow px-3 py-5 mb-5 bg-body rounded mt-5">
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Civil Engineering</h5>
                                <p>Previous year question papers for all semesters</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Mechanical Engineering</h5>
                                <p>Previous year question papers for all semesters</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Computer Science</h5>
                                <p>Previous year question papers for all semesters</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Electrical Engineering</h5>
                                <p>Previous year question papers for all semesters</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Electronics & Comm.</h5>
                                <p>Previous year question papers for all semesters</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="text-bg-light shadow px-3 pb-3 mb-3 bg-body rounded text-center">
                                <h5 class="pt-3 text-primary">Common Subjects</h5>
                                <p>Mathematics, Physics, Chemistry, English</p>
                                <a href="#" class="btn btn-outline-primary btn-sm">Download</a>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <p class="text-muted">Note: Question papers are provided for educational purposes only</p>
                    </div>
                </div>
            </div>
        </div>
