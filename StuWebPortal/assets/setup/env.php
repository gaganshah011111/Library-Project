...
if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'if0_40040294_gndpolyo_web');
if (!defined('DB_HOST'))                        define('DB_HOST', 'sql207.infinityfree.com');
// if (!defined('DB_HOST'))                        define('DB_HOST','162.241.218.223');
if (!defined('DB_USERNAME'))                    define('DB_USERNAME', 'if0_40040294');
// if (!defined('DB_USERNAME'))                    define('DB_USERNAME','gndpolyo_admin');
if (!defined('DB_PASSWORD'))                    define('DB_PASSWORD', 'Gagan123Shah');
