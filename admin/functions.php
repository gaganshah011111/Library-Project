...
{
	// include 'assets/imgresizePHP/ImageResize.php';/*Compression Class PHP Plugin - File Missing*/
...
function getGalleryImages($length, $place, $tOrf)
{
	...
	// Handle query error
	if (!$exe) {
		error_log("Gallery query failed: " . mysqli_error($conngndpc));
		return array(array()); // Return empty array if query fails
	}
